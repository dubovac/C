...
int main(void) {
	...
	int students0[] = {2, 7, 4};
	int studentsSize0 = 3;
	printf("%d\n", minMovesToSeat(seats0, seatsSize0, students0, studentsSize0));

	int seats1[] = {4, 1, 5, 9};
	int seatsSize1 = 4;
	int students1[] = {1, 3, 2, 6};
	int studentsSize1 = 4;
	printf("%d\n", minMovesToSeat(seats1, seatsSize1, students1, studentsSize1));

	int seats2[] = {2, 2, 6, 6};
	int seatsSize2 = 4;
	int students2[] = {1, 3, 2, 6};
	int studentsSize2 = 4;
	printf("%d\n", minMovesToSeat(seats2, seatsSize2, students2, studentsSize2));
}
